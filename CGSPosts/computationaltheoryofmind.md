...
$$\begin{align*}
\textbf{Mind-Body Identity Theory:} && \text{Identifying visual recognition with some neural activity in the visual cortex} \
&\Big\Downarrow && \
\textbf{Functionalism:} && \text{Visual recognition is processing some input by comparing it to previously seen data}
\end{align*}$$ 
